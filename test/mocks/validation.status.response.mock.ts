...
export const mockValidationStatusError6: ValidationStatusError = createMockValidationStatusError("You cannot remove a director from a company that has been dissolved or is in the process of being dissolved");
