...
import { DIRECTOR_DATE_DETAILS_PATH, DIRECTOR_NAME_PATH, urlParams, BASIC_STOP_PAGE_PATH } from "../../src/types/page.urls";
...
describe("Director name controller tests", () => {
    ...
    describe("post tests", () => {
      ...
      //   mockGetOfficerFiling.mockResolvedValueOnce({data:{
      //     referenceAppointmentId: "etag"
      //   }});
      //   mockGetCompanyAppointmentFullRecord.mockResolvedValueOnce({data:{
      //     referenceEtag: "different etag"
      //   }});
      //   const response = await request(app)
      //     .post(DIRECTOR_NAME_URL)
      //     .send({ 
