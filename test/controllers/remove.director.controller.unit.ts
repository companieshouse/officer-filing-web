    ...
    it("Should display stop page if validation status returns pre-2009 error", async () => {
      ...
      const response = await request(app)
        ...
        .send({ "removal_date-day": "1",
                ...
                expect(response.text).toEqual("Found. Redirecting to /appoint-update-remove-company-officer/company/12345678/transaction/11223344/submission/55555555/appointment/987654321/cannot-use?stopType=pre-october-2009");
