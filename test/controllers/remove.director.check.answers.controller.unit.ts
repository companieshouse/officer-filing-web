...
import { buildDateString, getDirectorAndTerminationDate, getMonthString } from "../../src/services/remove.directors.check.answers.service";
import { getCompanyProfile } from "../../src/services/company.profile.service";
import { buildAddress } from "../../src/services/confirm.company.service";

const mockCompanyAuthenticationMiddleware = companyAuthenticationMiddleware as jest.Mock;
mockCompanyAuthenticationMiddleware.mockImplementation((req, res, next) => next());
const mockGetDirectorAndTerminationDate = getDirectorAndTerminationDate as jest.Mock;
const mockGetMonthString = getMonthString as jest.Mock;
const mockBuildDateString = buildDateString as jest.Mock;
...
describe("Remove director check answers controller tests", () => {
  ...
  describe("get tests", () => {
    ...
    it("Should display summary for the non corporate director", async () => {
      ...
      //Date values are generated by the service which is mocked. Generated values are tested in service unit tests.
