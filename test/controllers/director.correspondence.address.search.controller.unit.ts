...
describe('Director correspondence address search controller test', () => {
  ...
  describe("get tests",  () => {
    it("Should navigate to director correspondence address search page", async () => {
  ...
  describe("post tests",  () => {
    ...
    // redirect tests
    it("Should navigate to director correspondence address choose address page when premises is null", async () => {
      mockGetIsValidUKPostcode.mockReturnValue(true);
      mockGetUKAddressesFromPostcode.mockReturnValue(mockResponseBodyOfUKAddresses);
    ...
    it("Should navigate to director correspondence address choose address page when premise is not part of returned addresses", async () => {
      mockGetIsValidUKPostcode.mockReturnValue(true);
      mockGetUKAddressesFromPostcode.mockReturnValue(mockResponseBodyOfUKAddresses);
    ...
    it("Should navigate to director correspondence address choose address page when premise is part of returned addresses", async () => {
      mockGetIsValidUKPostcode.mockReturnValue(true);
      mockGetUKAddressesFromPostcode.mockReturnValue(mockResponseBodyOfUKAddresses);
      const response = await request(app).post(PAGE_URL).send({"postcode": "SW1A1AA", "premises": "123"});
    ...
    it("Should navigate to director correspondence address choose address page when premise is part of returned addresses - case and space insensitivity", async () => {
      mockGetIsValidUKPostcode.mockReturnValue(true);
