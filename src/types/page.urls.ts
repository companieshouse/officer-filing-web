...
export const SERVICE_ERROR_PAGE = "/service-error";
export const SERVICE_ERROR_PATH = OFFICER_FILING + SERVICE_ERROR_PAGE;
export const PAGE_NOT_FOUND_PAGE = "/page-not-found";
export const PAGE_NOT_FOUND_PATH = OFFICER_FILING + PAGE_NOT_FOUND_PAGE;
...
export const CURRENT_DIRECTORS_PATH_END = "/current-directors";
export const CURRENT_DIRECTORS = ACTIVE_BASE + CURRENT_DIRECTORS_PATH_END;
...
export const UPDATE_DIRECTOR_LINK_CORRESPONDENCE_ADDRESS_ENTER_MANUALLY_PATH_END  = UPDATE_PATH + "link-correspondence-address-enter-manually"
export const UPDATE_DIRECTOR_LINK_CORRESPONDENCE_ADDRESS_ENTER_MANUALLY = ACTIVE_SUBMISSION_BASE + UPDATE_DIRECTOR_LINK_CORRESPONDENCE_ADDRESS_ENTER_MANUALLY_PATH_END;
export const UPDATE_DIRECTOR_LINK_CORRESPONDENCE_ADDRESS_ENTER_MANUALLY_PATH = OFFICER_FILING + UPDATE_DIRECTOR_LINK_CORRESPONDENCE_ADDRESS_ENTER_MANUALLY;
...
export const UPDATE_DIRECTOR_CORRESPONDENCE_ADDRESS_LINK_PATH_END = "/link-correspondence-address-update";
...
export const UPDATE_DIRECTOR_RESIDENTIAL_ADDRESS_SEARCH_PATH_END = UPDATE_PATH + "find-director-home-address";
