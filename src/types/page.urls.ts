...
export const REMOVE_DIRECTOR = "/company/00006400/transaction/020002-120116-793219/submission/1/" + REMOVE_DIRECTOR_PATH_END;
...
export const SHOW_STOP_PAGE_PATH = OFFICER_FILING + SHOW_STOP_PAGE + `?${URL_QUERY_PARAM.COMPANY_NUM}={${URL_QUERY_PARAM.COMPANY_NUM}}`;
