...
export const UPDATE_DIRECTOR_CHECK_ANSWERS_END = UPDATE_PATH + "director-check-answers";
...
export const UPDATE_DIRECTOR_NATIONALLITY_PATH_END = UPDATE_PATH + "director-nationality";
export const UPDATE_DIRECTOR_NATIONALITY = ACTIVE_SUBMISSION_BASE + UPDATE_DIRECTOR_NATIONALLITY_PATH_END;
