...
export const TRADING_STOP_PATH = OFFICER_FILING + TRADING_STOP;
export const WRONG_RO =  ACTIVE_SUBMISSION_BASE + Templates.WRONG_RO;
export const WRONG_RO_PATH = OFFICER_FILING + WRONG_RO;
export const WRONG_REGISTER_LOCATIONS = ACTIVE_SUBMISSION_BASE + Templates.WRONG_REGISTER_LOCATIONS;
export const WRONG_REGISTER_LOCATIONS_PATH = OFFICER_FILING + WRONG_REGISTER_LOCATIONS;
export const WRONG_OFFICER_DETAILS = ACTIVE_SUBMISSION_BASE + "incorrect-information/wrong-officer-details";
export const WRONG_OFFICER_DETAILS_PATH = OFFICER_FILING + WRONG_OFFICER_DETAILS;
