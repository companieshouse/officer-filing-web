...
export const APPOINT_DIRECTOR_CHECK_ANSWERS_PATH_END = "/appoint-director-check-answers"
...
export const DIRECTOR_MANUAL_ADDRESS_LOOKUP_PATH_END = "/director-manual-address-lookup";
export const DIRECTOR_MANUAL_ADDRESS_LOOK_UP = ACTIVE_SUBMISSION_BASE + DIRECTOR_MANUAL_ADDRESS_LOOKUP_PATH_END;
export const DIRECTOR_MANUAL_ADDRESS_LOOK_UP_PATH = OFFICER_FILING + DIRECTOR_MANUAL_ADDRESS_LOOK_UP;

export const DIRECTOR_ADDRESS_RESIDENTIAL_ADDRESS_LIST_PATH_END = "/director-address_residential_address_list";
export const DIRECTOR_ADDRESS_RESIDENTIAL_ADDRESS_LIST = ACTIVE_SUBMISSION_BASE + DIRECTOR_MANUAL_ADDRESS_LOOKUP_PATH_END;
export const DIRECTOR_ADDRESS_RESIDENTIAL_ADDRESS_LIST_PATH = OFFICER_FILING + DIRECTOR_MANUAL_ADDRESS_LOOK_UP;

export const DIRECTOR_CONFIRM_RESIDENTIAL_ADDRESS_SELECTION_PATH_END = "/director_residential_manual_address_confirmation";
export const DIRECTOR_CONFIRM_RESIDENTIAL_ADDRESS_SELECTION = ACTIVE_SUBMISSION_BASE + DIRECTOR_CONFIRM_RESIDENTIAL_ADDRESS_SELECTION_PATH_END;
export const DIRECTOR_CONFIRM_RESIDENTIAL_ADDRESS_SELECTION_PATH = OFFICER_FILING + DIRECTOR_CONFIRM_RESIDENTIAL_ADDRESS_SELECTION;
