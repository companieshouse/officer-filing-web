...
export const validateUKPostcode = async (postcodeValidationUrl: string, postcode: string, postcodeValidationType: PostcodeValidationType, validationErrors: ValidationError[]) => {
