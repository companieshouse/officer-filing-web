...
import { UPDATE_DIRECTOR_RESIDENTIAL_ADDRESS_PATH, UPDATE_DIRECTOR_RESIDENTIAL_ADDRESS_SEARCH_CHOOSE_ADDRESS_PATH } from "../../types/page.urls"
...
export const post = async (req: Request, resp: Response, next: NextFunction) => {
  postDirectorResidentialAddressSearch(req, resp, next, Templates.UPDATE_DIRECTOR_RESIDENTIAL_ADDRESS_SEARCH, UPDATE_DIRECTOR_RESIDENTIAL_ADDRESS_PATH, true);
};