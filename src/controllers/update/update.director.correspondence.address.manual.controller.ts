...
export const post = async (req: Request, res: Response, next: NextFunction) => {
  postDirectorCorrespondenceAddressManual(req, res, next, UPDATE_DIRECTOR_CONFIRM_CORRESPONDENCE_ADDRESS_PATH, Templates.DIRECTOR_CORRESPONDENCE_ADDRESS_MANUAL, UPDATE_DIRECTOR_CORRESPONDENCE_ADDRESS_SEARCH_PATH, true);
};
