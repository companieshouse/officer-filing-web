...
export const post = async (req: Request, res: Response, next: NextFunction) => {
  await postCorrespondenceAddressChooseAddress(req, res, next, Templates.UPDATE_RESIDENTIAL_CHOOSE_ADDRESS, UPDATE_DIRECTOR_CORRESPONDENCE_ADDRESS_SEARCH_PATH, UPDATE_DIRECTOR_CONFIRM_CORRESPONDENCE_ADDRESS_PATH, true);
};