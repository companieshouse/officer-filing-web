...
async function beginUpdateJourney(req: Request, res: Response, session: Session, companyNumber: string, transactionId: string, appointmentId: any, lang: string | undefined) {
  ...
  const officerFiling: OfficerFiling = {
    ...
    nationality1: nationalities![0] ? formatTitleCase(nationalities![0]): "",
    nationality2: nationalities![1] ? formatTitleCase(nationalities![1]): "",
    nationality3: nationalities![2] ? formatTitleCase(nationalities![2]): "",
    serviceAddress: {
